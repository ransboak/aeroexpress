                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('shipments.store', $package->id) }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tracking_number" class="form-control" value="{{$package->tracking_number}}" id="tracking_number" required readonly>
                                                    
                                            <div>
                                                <label for="description">Package Description</label>
                                            <textarea style="resize: none" rows="5" name="description" class="form-control" id="description" required>{{$package->description}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label >Status</label>
                                                                    <div>
