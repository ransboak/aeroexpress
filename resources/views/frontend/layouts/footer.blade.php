        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-4 footer__widget footer__widget-about">
            <div class="footer__widget-content">
              <img src="{{asset('frontend/assets/images/logo/logo-small.png')}}" alt="logo" class="footer-logo">
              ...
              <ul class="contact__list list-unstyled">
                <li><span>Email:</span><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7e310e0a17131b3e49110c111118501d1113">[email&nbsp;protected]</a></span></li>
        ...
        <div class="row align-items-center">
          <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="footer__copyright">
              <span>© <script>document.write(new Date().getFullYear())</script> Optime, with Love by</span>
