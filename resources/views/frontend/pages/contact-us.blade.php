...
<body>
      ...
      <nav class="navbar navbar-expand-lg sticky-navbar">
        <div class="container">
          <a class="navbar-brand" href="{{route('home')}}">
            <img src="{{asset('frontend/assets/images/logo-light.png')}}" class="logo-light" alt="logo">
            <img src="{{asset('frontend/assets/images/logo-dark.png')}}" class="logo-dark" alt="logo">
          </a>
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav ml-auto">
              <li class="nav__item with-dropdown">
                <a href="{{route('home')}}" class="dropdown-toggle nav__item-link">Home</a>
              ...
              <li class="nav__item with-dropdown">
                <a href="{{route('aboutUs')}}" class="dropdown-toggle nav__item-link">Company</a>
                <i class="fa fa-angle-right" data-toggle="dropdown"></i>
                <ul class="dropdown-menu">
              ...
              <li class="nav__item with-dropdown">
                <a href="" class="dropdown-toggle nav__item-link">News &amp; Media</a>
                <i class="fa fa-angle-right" data-toggle="dropdown"></i>
                <ul class="dropdown-menu">
              ...
              <li class="nav__item">
                <a href="{{route('contactUs')}}" class="nav__item-link active">Contacts</a>
              </li><!-- /.nav-item -->
            </ul><!-- /.navbar-nav -->
          </div><!-- /.navbar-collapse -->
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="langDrobdown">
                    <a class="dropdown-item" href="#">
                      <img src="{{asset('frontend/assets/images/united-states.png')}}" alt="us"><span>Us</span>
                    </a>
                    <a class="dropdown-item" href="#">
                      <img src="{{asset('frontend/assets/images/germany.png')}}" alt="germany"><span>germany</span>
                    </a>
                  </div>
                </div>
              </li>
            ...
            <form method="post" action="assets/php/contact.php" id="contactForm">
              <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group"><input type="text" class="form-control" id="contact-name" name="contact-name" placeholder="Name" required=""></div>
                </div><!-- /.col-lg-6 -->
                <div class="col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group"><input type="email" class="form-control" id="contact-email" name="contact-email" placeholder="Email" required=""></div>
                </div><!-- /.col-lg-6 -->
              </div><!-- /.row -->
              <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group"><input type="text" class="form-control" placeholder="Phone" id="contact-Phone" name="contact-phone" required=""></div>
                </div><!-- /.col-lg-6 -->
                <div class="col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group"><input type="text" class="form-control" placeholder="Company" id="contact-Company" name="contact-Company" required=""></div>
                </div><!-- /.col-lg-6 -->
              </div><!-- /.row -->
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <div class="form-group">
                    <textarea class="form-control" placeholder="Request Details" id="contact-message" name="contact-message" required=""></textarea>
                  </div>
                </div><!-- /.col-lg-12 -->
              </div><!-- /.row -->
              <div class="row">
        ...
        <div class="row">
            ...
            <div class="contact-panel">
              <div class="contact__panel-header">
                <div class="contact__panel-icon">
                  <img src="{{asset('frontend/assets/images/united-states.png')}}" alt="us">
              ...
              <ul class="contact__list list-unstyled">
                ...
                <li>Email: <a href="milto:Optime@7oroof.com"><span class="__cf_email__" data-cfemail="5f102f2b36323a1f68302d303039713c3032">[email&nbsp;protected]</span></a></li>
          ...
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="contact-panel">
              <div class="contact__panel-header">
                <div class="contact__panel-icon">
                  <img src="{{asset('frontend/assets/images/germany.png')}}" alt="germany">
                </div><!-- /.contact-panel-icon -->
                <h4 class="contact__panel-title">Germany</h4>
              </div><!-- /.contact-panel-header -->
              <ul class="contact__list list-unstyled">
                <li>002 010123456789</li>
                <li>Email: <a href="milto:Optime@7oroof.com"><span class="__cf_email__" data-cfemail="a2edd2d6cbcfc7e295cdd0cdcdc48cc1cdcf">[email&nbsp;protected]</span></a></li>
                <li>Address: 2307 Beverley Rd Brooklyn, NY</li>
                <li>Hours: Mon-Fri: 8am – 7pm</li>
              </ul><!-- /.contact-list -->
              <a href="#" class="btn btn__primary btn__hover3">
          ...
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="contact-panel">
              <div class="contact__panel-header">
                <div class="contact__panel-icon">
                  <img src="{{asset('frontend/assets/images/canada.png')}}" alt="canada">
                </div><!-- /.contact-panel-icon -->
                <h4 class="contact__panel-title">Canada</h4>
              </div><!-- /.contact-panel-header -->
              <ul class="contact__list list-unstyled">
                <li>002 010123456789</li>
                <li>Email: <a href="milto:Optime@7oroof.com"><span class="__cf_email__" data-cfemail="602f1014090d0520570f120f0f064e030f0d">[email&nbsp;protected]</span></a></li>
                <li>Address: 2307 Beverley Rd Brooklyn, NY</li>
                <li>Hours: Mon-Fri: 8am – 7pm</li>
              </ul><!-- /.contact-list -->
              <a href="#" class="btn btn__primary btn__hover3">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-4 footer__widget footer__widget-about">
              <div class="footer__widget-content">
                <img src="{{asset('frontend/assets/images/logo-small.png')}}" alt="logo" class="footer-logo">
                ...
                <ul class="contact__list list-unstyled">
                  <li><span>Email:</span><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0d427d796460684d3a627f62626b236e6260">[email&nbsp;protected]</a></span></li>
          ...
          <div class="row align-items-center">
            <div class="col-sm-12 col-md-6 col-lg-6">
              <div class="footer__copyright">
                <span>© 2019 Optime, with Love by</span>
  ...
  <script data-cfasync="false" src="{{asset('frontend/assets/js/email-decode.min.js')}}"></script><script src="{{asset('frontend/assets/js/jquery-3.3.1.min.js')}}"></script>
